...
//import java.sql.SQLException;
//
//public class ShelfStockDAO implements IShelfStockDAO {
//    private final Connection connection;
//
//    public ShelfStockDAO(Connection connection) {
//        this.connection = connection;
...
public class ShelfStockDAO implements IShelfStockDAO {
    ...
    // Update the shelf stock quantity
    @Override
    public void updateShelfStockQuantity(int productId, int newQuantity) throws SQLException {
        String sql = "UPDATE shelf_stock SET quantity = ? WHERE product_id = ?";
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
